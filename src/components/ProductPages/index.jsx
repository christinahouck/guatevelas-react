                  ...
                  <ProductContainer key={`prodSect${index}`}>
                    ...
                    <ProdSectionInfo>
                      ...
                      {theme["lang"] === "en" ? (
                        ...
                        <GTBuyLink
                          href={`mailto:guatemalavelas@gmail.com?&subject=Nuevo%20pedido&body=Hola, vivo en Guatemala y me gustaría comprar una vela. Estoy interesado en el modelo ${item.title} en el color ${this.props.color}. Un saludo.`}
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                          Comprar por correo-e (disponible sólamente en
                          Guatemala)
                        </GTBuyLink>
                      )}
                    </ProdSectionInfo>
